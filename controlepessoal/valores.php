...
if ($acao == 'editar') {
        ...
        $consulta = $pdo->query("SELECT * FROM valores WHERE id = '$id'");
...
<div class="container">
    <form <?php echo 'action="acao.php?table=valores&acao='.$acao.'&codigo='.$id.'"'; ?> method="post">
        ...
        <div class="row">
            <div class="col-3">
                <label class="form-label" for="numero">Valor</label>
